    ...
    <div className="pt-20">
      ...
      <section className="bg-gray-100 py-16 px-[5%]">
        ...
        <p className="text-center text-gray-600 mt-4 max-w-2xl mx-auto">
          Une question ? N'hesitez pas a nous contacter, nous vous repondrons dans les meilleurs delais.
        </p>
      </section>
            ...
            <div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Association Ultra Trail de la Ria<br />
                      Salle Emeraude<br />
                      56550 Locoal-Mendon
                    </p>
                  </div>
              ...
              <div className="mt-12">
                ...
                <div className="flex gap-4">
                  <a
                    href="#"
                    className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center hover:bg-cyan-100 transition-colors"
                    aria-label="Facebook"
                  >
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    ...
                    className="w-full bg-cyan-500 hover:bg-cyan-600 disabled:bg-cyan-300 text-white font-bold py-4 px-6 rounded-lg transition-colors"
                  >
